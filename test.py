from datetime import date, time, datetime, timezone # https://docs.python.org/3/library/datetime.html
...
def runSchedule(todaysRecordingSchedule):
	...
	for showInfo in todaysRecordingSchedule:
		...
		recorderSchedule.enterabs(showInfo['showStart'], 0, record, argument=(duration, showInfo))
...
runSchedule([{'showName' : '💯💯💯',
	'showFileName': '2023-1-1_💯💯💯.mp3',
	'showStart' : time.time(),
	'showEnd' : time.time()+20,
	'duration' : 20,
	'email' : 'jeffreychen2168@gmail.com',
	'dj': 'emojiDJ'},
	{'showName' : '///',
	'showFileName': '2023-1-1_123413.mp3',
	'showStart' : time.time()+20,
	'showEnd' : time.time()+40,
	'duration' : 20,
	'email' : 'jeffreychen2168@gmail.com',
	'dj': 'invalid filename DJ'}]
)
